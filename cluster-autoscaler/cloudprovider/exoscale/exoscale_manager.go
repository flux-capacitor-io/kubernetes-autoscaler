...
type exoscaleClient interface {
	...
	ListInstanceTypes(ctx context.Context, zone string) ([]*egoscale.InstanceType, error)
	ListSecurityGroups(ctx context.Context, zone string) ([]*egoscale.SecurityGroup, error)
